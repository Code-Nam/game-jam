...
const dialogues = [
	...
	"Je crois qu'une tragédie m'attends",
	"Comment lui avouer que je l'aime",
	"Sans lui faire part de... Oh !",
	"Salut toi... Que fais-tu donc ici ?",
	"Une jolie petite chose comme toi ne devrais pas roder dans un cimetière",
	"Enfin...",
	"Avec une aussi jolie petite bouille",
	"Et de charmants bras",
	"Et de longues jambes",
	"Oh...",
	"Ils m'iraient si bien...",
	"D O N N E L E S M O I",
	"Zero ? Qu'est-ce que...",
	"HEY ! DEGAGE DE MA TRONCHE",
	"Urgh...",
	"Tu ne pourras pas te cacher éternellement ! Montre-toi !"
];
...
const dialogues2 = [
	...
	// "Right ?",
	// "NO ! Help-"
	"Où est passé ce sale môme...",
	"Montre-to.... AAAAAAAAAH",
	"Qui a creusé un trou de tombe ici ?",
	'Ah.... Te voilà !',
	"Donne-moi ta main pour que je puisse sortir de là, d'accord ?",
	"Attend... Qu'est-ce que tu fais avec ce cercueil ?",
	"Tu... Tu n'oserais pas le pousser sur une jeune fille innocente et fragile, n'est-ce pas ?",
	'Pas vrai ?',
	'NON !! Arrêt-'
];
